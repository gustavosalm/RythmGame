...
public class ScenarioMovement : MonoBehaviour
{
    ...
    void Start(){
        ...
        if(speed < 0){
            scenarios[1].transform.localPosition = scenarios[0].transform.localPosition - new Vector3(800, 0);
            scenarios[2].transform.localPosition = scenarios[1].transform.localPosition - new Vector3(800, 0);
        }
    }
    ...
    public void NextScenario(){
        ...
        scenarios[3].transform.localPosition = scenarios[2].transform.localPosition + new Vector3(800 * ((speed > 0) ? 1 : -1), 0);
